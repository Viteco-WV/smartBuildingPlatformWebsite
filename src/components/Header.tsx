  ...
  return (
    <header className="bg-white text-gray-900 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-3 lg:items-center flex items-center justify-between py-4">
          {/* Logo links */}
          ...
          <nav className="hidden lg:flex space-x-8 justify-center">
            <RouterLink href="/platform" className="text-black hover:text-[#00e886] transition-colors" activeClassName="text-[#00e886] font-semibold">
              Platform
            </RouterLink>
            <RouterLink href="/services" className="text-black hover:text-[#00e886] transition-colors" activeClassName="text-[#00e886] font-semibold">
              Services
            </RouterLink>
            <div className="relative group">
              <button className={`text-black hover:text-[#00e886] transition-colors flex items-center space-x-1 ${isOverOnsActive ? 'font-semibold' : ''}`}>
                <span>Over ons</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 hidden group-hover:block group-focus-within:block hover:block border border-gray-200">
          ...
          <div className="lg:hidden border-t border-gray-200 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 mt-4">
                <RouterLink href="/demo" className="bg-[#00e886] text-white px-6 py-2 rounded-lg hover:bg-[#00d676] transition-all w-full max-w-xs mx-auto text-sm sm:text-base font-bold">
                  Koffie doen?
                </RouterLink>
                <RouterLink href="/login" className="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition-all w-full max-w-xs mx-auto">
                  Login
                </RouterLink>
              </div>
            </nav>
