...
export default function GacsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ name: form.name, email: form.email, organization: "GACS audit aanvraag", message: `Telefoon: ${form.phone}` }),
      });
      if (res.ok) {
        setSuccess(true);
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-5xl font-extrabold mb-2 text-center">WHAT THE GACS?!</h1>
      ...
      <section className="mb-8 bg-gray-50 rounded-xl shadow-lg p-8">
        <h2 className="text-2xl font-semibold mb-2">Wat is GACS?</h2>
        <p>
      ...
      <section className="mb-8 bg-gray-50 rounded-xl shadow-lg p-8">
        <h2 className="text-2xl font-semibold mb-2">Wat is GACS niet?</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-8 text-center">Stappenplan: zo wordt uw gebouw GACS compliant</h2>
            ...
            <li className="relative flex items-center group">
              <div className="flex-1 flex justify-end pr-8">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-xl w-full text-left mx-auto">
                  ...
                  <div className="text-lg font-bold mb-2">1-daagse GACS Audit</div>
            ...
            <li className="relative flex items-center group">
              ...
              <div className="flex-1 flex justify-start pl-8">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-xl w-full text-left mx-auto">
                  ...
                  <div className="text-lg font-bold mb-2">Implementatie SkySpark EMS</div>
                  <ul className="list-disc pl-6 text-left text-sm text-gray-700 mb-2">
            ...
            <li className="relative flex items-center group">
              <div className="flex-1 flex justify-end pr-8">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-xl w-full text-left mx-auto">
                  ...
                  <div className="text-lg font-bold mb-2">Hardwarematige GACS implementatiebegeleiding</div>
                  <ul className="list-disc pl-6 text-left text-sm text-gray-700 mb-2">
      ...
      <section className="mb-8 bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl font-semibold mb-2">Volledige ontzorging: SkySpark EMS &amp; Backoffice</h2>
      ...
      <section className="mb-8 bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl font-semibold mb-4">SkySpark EMS modules &amp; GACS klassen</h2>
        <p className="mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Deze gebouwen zijn GACS compliant</h2>
        <div className="relative overflow-x-auto">
          <div className="flex gap-6 py-4 min-w-max" style={{scrollbarWidth: 'thin'}}>
            {caseStudiesData.slice(0, 10).map((gebouw) => (
              <div key={gebouw.id} className="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col min-w-[260px] max-w-xs w-full">
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-semibold mb-1">{gebouw.title}</h3>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md relative animate-fadeIn">
            ...
            {!success ? (
              <form className="space-y-6" onSubmit={handleSubmit}>
                <h3 className="text-2xl font-bold mb-2 text-center">Vraag GACS-audit aan</h3>
                <div>
