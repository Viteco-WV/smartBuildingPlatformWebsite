  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-16">
        <h1 className="text-3xl md:text-4xl font-bold mb-4 text-black">Vacature: Data Consultant & Rapportagespecialist</h1>
        <div className="mb-2 text-black">Locatie: Beverwijk | Dienstverband: Minimaal 32 uur</div>
        ...
        <p className="mb-4 text-black">Bij Infinity Analysis & Consultancy zetten we data om in inzichten en inzichten om in actie. Wij meten de werking van gebouwinstallaties en vertalen de vrijgekomen data naar begrijpelijke informatie. Het resultaat: intelligent en onafhankelijk beheer van gebouwen en het continu optimaliseren van klimaatbeheersing op basis van meetgegevens. Onze ambitie is om via data-analyse en machine learning bij te dragen aan slimme gebouwen en energiebesparing.</p>
        <h2 className="text-xl font-bold mt-8 mb-2 text-black">Jouw rol</h2>
        <p className="mb-4 text-black">Als Data Consultant & Rapportagespecialist ben jij een essentiële schakel binnen ons team. Je stelt heldere, diepgaande rapportages op voor onze consultancyprojecten en ondersteunt bij uiteenlopende data-gerelateerde werkzaamheden binnen ons kantoor. Daarnaast communiceer je de rapporten richting onze klanten en geef je, waar nodig, aanvullende toelichting om ervoor te zorgen dat zij volledig inzicht hebben in de analyses en adviezen.</p>
